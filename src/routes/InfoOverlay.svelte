			...
			>
				...
				<div class="text-xs leading-relaxed overflow-y-auto space-y-2">
					...
					{:else if open_section === 'Methodology'}
						...
						<p>
							Satellite positions are propagated at a fixed tick rate of {TICK_RATE_SECONDS} seconds.
						...
						<p>
							...
							your web browser's local storage. Updated TLEs are fetched from
							<a class="info-link" href="https://celestrak.org">Celestrak</a>
					...
					{:else if open_section === 'What is this?'}
						...
						<p>
							The Earth and all satellite orbits are shown to-scale. Satellites are displayed in
							their current computed positions at this very moment, you can learn more about this
							computuation under <strong>Data</strong> and <strong>Methodology</strong>.
						</p>
						<p>
							This is not a live radar feed. It is a physics-based simulation using
							industry-standard orbital data and computational models used in real satellite
							operations.
						</p>
						<p>
